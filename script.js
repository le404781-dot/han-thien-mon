...
function renderCultivation(p){
 ...
 <p id="trainMsg" class="train-msg">Lượt tu luyện hôm nay = lượt vận công: <b>${trainCount}/${maxDaily}</b>. ${trainCount>=maxDaily?'Đã hết lượt vận công hôm nay; chế độ tích lũy online có thể tiếp tục hoạt động.':'Mỗi lần vận công chính là 1 lượt tu luyện trong ngày.'}</p>`;
