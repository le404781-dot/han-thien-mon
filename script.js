...
async function checkSession(){
 ...
 try{const d=await api('/api/me',{headers:authHeaders()});accountUI(d.user);await loadProfile();await loadCultivationSafe();await loadEquipment();await loadChat();await loadLeaderboard();await loadTreasure();await loadBeastHouse();await loadLinhPhap();await loadTuDi();await loadMarket();await loadQuests();await loadChallenges();}
